...
export default function ProjectThumbnail2(props: Props) {
    if (props.isLink == "image-link") {
        return (
            <div className="h-full flex flex-col group">
                <div className="flex gap-2 items-center mb-4">
                    <p className="text-sm text-[var(--colour-bodytext-3)] md:text-[var(--colour-bodytext-4)] md:group-hover:text-[var(--main-colour)] leading-loose">
                        {props.name}
                    </p>
                    <p className="text-sm text-[var(--colour-bodytext-3)] md:text-[var(--colour-bodytext-4)] md:group-hover:text-[var(--main-colour)] leading-loose">
                        &middot;
                ...
                <a className="relative block overflow-hidden group mt-auto bg-[var(--container-bg)] rounded-3xl shadow-[0px_0px_15px_rgba(0,0,0,0.01)] 2xl:shadow-[0px_0px_35px_rgba(0,0,0,0.01)]" href={props.link} target={props.target}>
        ...
        return (
            <div className="h-full flex flex-col group">
                <div className="flex gap-2 items-center mb-4">
                    <p className="text-sm text-[var(--colour-bodytext-3)] md:text-[var(--colour-bodytext-4)] leading-loose md:group-hover:text-[var(--main-colour)]">
                        {props.name}
                    </p>
                    <p className="text-sm text-[var(--colour-bodytext-3)] md:text-[var(--colour-bodytext-4)] md:group-hover:text-[var(--main-colour)] leading-loose">
                        &middot;
