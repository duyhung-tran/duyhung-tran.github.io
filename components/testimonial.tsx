...
export default function Testimonial(props: Props) {
    return (
        <div className="flex flex-col justify-between bg-[var(--container-bg)] shadow-[0px_0px_15px_rgba(0,0,0,0.01)] px-7 py-5 rounded-2xl">
            <p className="text-sm text-[var(--colour-bodytext-light)] leading-loose">"{props.text}"</p> 
            ...
            <div className="flex gap-4 items-center">
                ...
                <div>
                    ...
                    <p className="text-sm text-[var(--colour-bodytext-light)] leading-loose">{props.job} at {props.company}.</p>
                </div>
            </div>
        </div>
    );
