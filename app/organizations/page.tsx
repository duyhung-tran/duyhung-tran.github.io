        ...
        <div className="grid *:grid-cols-1 lg:grid-cols-[1fr_3fr]">
            ...
            <div className="mt-15 lg:mt-10 pr-0 lg:pr-18">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-3">
                    <ProjectThumbnailNew isLink="image-link" link="knoxai" type="UX design, shipped" name="Samsung Knox AI's interactive widgets" desc="Reusable chassis for Knox Cloud Services' AI assistant" imageSrc="/yuhh.png" imageSrcDark="/yuhh.png" imageSrcPoster="" imageSrcPosterDark="" target="_self"/>
